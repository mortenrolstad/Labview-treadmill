...
<Project Type="Project" LVVersion="19008000">
	...
	<Property Name="varPersistentID:{A3383A5E-F29C-4E0D-A8C8-24708B443856}" Type="Ref">/My Computer/kalibreringvekt.lvlib/Variable1</Property>
	<Property Name="varPersistentID:{C506474F-9486-44D3-B7D8-70363E0A3CE5}" Type="Ref">/NI-myRIO-1900-03192741/kalibrering Library 2.lvlib/Variable2</Property>
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Project Documentation" Type="Folder">
			<Item Name="Documentation Images" Type="Folder">
				<Item Name="myRIO_Project_Diagram.gif" Type="Document" URL="../../../Bilder/Dokumenter/LabVIEW Data/Bachelor vår 2022/documentation/myRIO_Project_Diagram.gif"/>
			</Item>
			<Item Name="myRIO Project Documentation.html" Type="Document" URL="../../../Bilder/Dokumenter/LabVIEW Data/Bachelor vår 2022/documentation/myRIO Project Documentation.html"/>
		</Item>
		<Item Name="kalibreringvekt.lvlib" Type="Library" URL="../sensorer sub vi/kalibreringvekt.lvlib"/>
		<Item Name="kalibreringvekt.vi" Type="VI" URL="../sensorer sub vi/kalibreringvekt.vi"/>
	...
	<Item Name="NI-myRIO-1900-03192741" Type="RT myRIO">
		<Property Name="alias.name" Type="Str">NI-myRIO-1900-03192741</Property>
...
AddOutputFilter chunkFilter
		...
		<Item Name="Calibrering.vi" Type="VI" URL="../Calibrering.vi"/>
		<Item Name="kalibrering Library 2.lvlib" Type="Library" URL="../sensorer sub vi/kalibrering Library 2.lvlib"/>
		<Item Name="Load Cell and Motor Controller.vi" Type="VI" URL="../../BachelorProject(gammel opg)/Load Cell measure/Measurement/Load Cell and Motor Controller.vi"/>
		<Item Name="load cells.vi" Type="VI" URL="../load cells.vi"/>
		<Item Name="Sensorer_Cop.vi" Type="VI" URL="../Sensorer_Cop.vi"/>
		<Item Name="Motors.vi" Type="VI" URL="../Motors.vi"/>
		<Item Name="Untitled 4 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Untitled 4 (SubVI).vi"/>
		<Item Name="x_y(F.R).vi" Type="VI" URL="../sensorer sub vi/x_y(F.R).vi"/>
		<Item Name="test hal sensor.vi" Type="VI" URL="../test hal sensor.vi"/>
		<Item Name="pulsteller.vi" Type="VI" URL="../pulsteller.vi"/>
		<Item Name="testenc.vi" Type="VI" URL="../testenc.vi"/>
		<Item Name="Dependencies" Type="Dependencies">
			<Item Name="vi.lib" Type="Folder">
			...
			<Item Name="cp11.vi" Type="VI" URL="../cp11.vi"/>
			<Item Name="lvanlys.dll" Type="Document" URL="/&lt;resource&gt;/lvanlys.dll"/>
			<Item Name="NiFpgaLv.dll" Type="Document" URL="NiFpgaLv.dll">
				<Property Name="NI.PreserveRelativePath" Type="Bool">true</Property>
			</Item>
			<Item Name="Sensorer 1 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 1 (SubVI).vi"/>
			<Item Name="Sensorer 2 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 2 (SubVI).vi"/>
			<Item Name="Sensorer 3 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 3 (SubVI).vi"/>
			<Item Name="Sensorer 4 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 4 (SubVI).vi"/>
			<Item Name="Sensorer 5 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 5 (SubVI).vi"/>
			<Item Name="Sensorer 6 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 6 (SubVI).vi"/>
			<Item Name="Sensorer 7 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 7 (SubVI).vi"/>
			<Item Name="Sensorer 8 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 8 (SubVI).vi"/>
			<Item Name="Sensorer 9 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 9 (SubVI).vi"/>
			<Item Name="Sensorer 10 (SubVI).vi" Type="VI" URL="../sensorer sub vi/Sensorer 10 (SubVI).vi"/>
			<Item Name="x_y(F.L).vi" Type="VI" URL="../sensorer sub vi/x_y(F.L).vi"/>
		</Item>
		<Item Name="Build Specifications" Type="Build"/>
	</Item>
</Project>
